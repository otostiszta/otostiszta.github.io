      ...
      <div class="flex flex-col px-1 pt-2 w-full h-full justify-center md:justify-start">
        ...
        <div class="bg-[#0a0a0a] rounded-sm border-b border-gray-800 shadow-[inset_0_2px_10px_rgba(0,0,0,1)] relative h-auto py-6 md:py-0 md:h-[95px] overflow-hidden mb-2 mx-1">
          ...
          <div class="h-full relative z-10 p-3 flex flex-col justify-center">
            ...
            <!-- Frequencies Row -->
            <div class="flex flex-col md:flex-row justify-between items-center md:items-baseline gap-8 md:gap-0 mb-1 relative">
        ...
        <!-- Bottom Buttons Row -->
        <div class="hidden md:flex justify-between items-center px-4 mt-auto mb-3">
